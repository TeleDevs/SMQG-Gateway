...
//        nuvemBtn.setOnClickListener(v -> sendMqtt("{\"cod\":1}."));
        return view;
    }
...
//    private void sendMqtt(String str){
//        String clientId = MqttClient.generateClientId();
//        MqttAndroidClient client =
//                new MqttAndroidClient(this.getActivity(), "tcp://broker.hivemq.com:1883",
//                        clientId);
//
//        try {
...
//                    // We are connected
//                    Toast.makeText(getActivity(), "Sucesso MQTT", Toast.LENGTH_SHORT).show();
//                }
//
//                @Override
//                public void onFailure(IMqttToken asyncActionToken, Throwable exception) {
//                    Toast.makeText(getActivity(), "Falha MQTT", Toast.LENGTH_SHORT).show();
//
//                }
//            });
